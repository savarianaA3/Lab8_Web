...
### Membuat database
![img2!](lab8_php_database/img/Membuat Database.png)

### Menambahkan Data
![img3!](lab8_php_database/img/Menambahkan Data.png)

![img4!](lab8_php_database/img/Menambahkan Data3.png)

## 3. Membuat Program CRUD
Buat folder lab8_php_database pada root directory web server (/Application/xampp/htdocs)

![img5!](lab8_php_database/img/Lab8.png)

Kemudian untuk mengakses direktory tersebut pada web server dengan mengakses URL:
http://localhost/tugas_lab8_php_database/lab8_php_database/

![img6!](lab8_php_database/img/la8php.png)

## Membuat file koneksi database

Buka melalui browser untuk menguji koneksi database (untuk menyampilkan pesan koneksi berhasil), uncomment pada perintah echo “koneksi berhasil”;

![img7!](lab8_php_database/img/Koneksi.png)
...
```
![img8!](lab8_php_database/img/indexphp.png)
...
```
![img9!](lab8_php_database/img/tambahphp.png)
...
Proses ubah
![img11!](lab8_php_database/img/proses diubah.png)
...
Sebelum dihapus
![img13!](lab8_php_database/img/sebelum dihapus.png)

Setelah dihapus
![img14!](lab8_php_database/img/setelah dihapus.png)
